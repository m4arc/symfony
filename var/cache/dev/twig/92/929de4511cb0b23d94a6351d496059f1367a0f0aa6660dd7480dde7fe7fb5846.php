...
class __TwigTemplate_ecfd13666383e949d3eabc1c272b5cdf655de85d5fdedf8675dcdac17f16f078 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_fallback_messages($context, array $blocks = [])
    {
        ...
        // line 155
        echo "                        ";
        echo twig_call_macro($macros["helper"], "macro_render_table", [(isset($context["messages_fallback"]) || array_key_exists("messages_fallback", $context) ? $context["messages_fallback"] : (function () { throw new RuntimeError('Variable "messages_fallback" does not exist.', 155, $this->source); })())], 155, $context, $this->getSourceContext());
        echo "
                    ";
